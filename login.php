...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (login($email, $password)) {
        if (isAdmin()) {
            // Admins should use admin/login.php
            logout();
            $error = 'Please use admin login page for admin access.';
        } else {
...
<body>
    <div class="login-card p-4 p-md-5">
        ...
        <div class="text-center">
            ...
            <a href="auth/register.php" class="text-decoration-none">Create account</a>
        </div>
