...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        try {
            $stmt = $pdo->prepare("INSERT INTO products (name, slug, description, price, category_id, image_url, stock_quantity, status, badge) 
                                   VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
            $stmt->execute([
                ...
                <div class="row">
                    <div class="col-md-8">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" id="price" name="price" 
                                           step="0.01" min="0" required value="<?= htmlspecialchars($_POST['price'] ?? '') ?>">
                                </div>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="badge" name="badge" 
                                   value="<?= htmlspecialchars($_POST['badge'] ?? '') ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Upload JPEG, PNG, WebP, or GIF</small>
                        </div>
